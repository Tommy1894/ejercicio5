...
class PDF extends FPDF
{
   ...
   {  
      ...
      $this->Cell(35, 10, utf8_decode('CEDULA'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('NOMBRE'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('APELLIDO'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('EDAD'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('SEXO'), 1, 1, 'C', 1);
...
foreach ($data as $row) {
   if($row['sexo']=="M"){
    ...
    $pdf->Cell(35, 10, utf8_decode($row['cedula']), 1, 0, 'C'); // Centra la cédula
    $pdf->Cell(35, 10, utf8_decode($row['nombre']), 1, 0, 'C'); // Centra el nombre
    $pdf->Cell(35, 10, utf8_decode($row['apellido']), 1, 0, 'C'); // Centra el apellido
    $pdf->Cell(35, 10, utf8_decode($row['edad']), 1, 0, 'C'); // Centra el apellido
    $pdf->Cell(35, 10, utf8_decode($sexo), 1, 1, 'C'); // Centra la zona/país y salta de línea
    $N_contador++;
}
